...
- `point` (==default==) | `triangle` | `box` | `diamond` | `pentagon` | `hexagon` | `octagon` | `star` | `vertical-line`
...
gantt-symbol: star # Event will be star-shaped
---
...
gantt-symbol: era # Event will be an era
---
```
